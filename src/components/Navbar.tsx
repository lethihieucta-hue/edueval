      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-3">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-600 to-indigo-500 flex items-center justify-center shadow-md shadow-blue-500/20 text-white font-bold">
              <GraduationCap className="w-6 h-6" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <span className="font-extrabold text-lg tracking-tight text-white bg-gradient-to-r from-blue-400 to-indigo-300 bg-clip-text text-transparent">
                  EduEval
                </span>
              ...
              <p className="text-[11px] text-slate-400">Đánh Giá & Phát Triển Năng Lực Viên Chức THPT</p>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-2 flex-1 max-w-sm mx-2">
            <div className="relative w-full">
              ...
              <input
                ...
                placeholder="Tìm giáo viên, mã GV..."
                className="w-full pl-9 pr-3 py-1.5 bg-slate-800 border border-slate-700 rounded-lg text-xs text-slate-200 placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
              />
            </div>
            <select
              value={selectedDepartment}
              onChange={(e) => setSelectedDepartment(e.target.value)}
              className="bg-slate-800 border border-slate-700 text-xs text-slate-200 rounded-lg px-2 py-1.5 focus:outline-none focus:border-blue-500 transition-all cursor-pointer shrink-0"
            >
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
            ...
            <div className="flex items-center bg-slate-800 p-1 rounded-xl border border-slate-700">
              ...
              <button
                ...
                title="Chế độ Tổ trưởng chuyên môn"
              >
                <UserCheck className="w-3.5 h-3.5" />
                <span className="hidden md:inline">Tổ Trưởng</span>
              </button>
